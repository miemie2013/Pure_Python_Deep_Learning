...
if __name__ == '__main__':
    ...
    with fluid.program_guard(eval_prog, startup_prog):
        with fluid.unique_name.guard():
            ...
            bn02_out_tensor = fluid.layers.batch_norm(
                ...
                moving_variance_name=bn_name + '_variance')
            act02_out_tensor = fluid.layers.leaky_relu(bn02_out_tensor, alpha=0.1)
            eval_fetch_list = [bn01_out_tensor, bn02_out_tensor]
    ...
    for step in range(8):
        ...
        paddle_mseloss_out, paddle_bn01_out, paddle_bn02_out = exe.run(train_prog, feed={"input_1": batch_data, "y_true": y_true_arr, },
                                                                       fetch_list=[mseloss, bn01_out_tensor, bn02_out_tensor])
